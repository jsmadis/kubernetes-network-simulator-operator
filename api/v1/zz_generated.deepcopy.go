...
func (in *NetworkSpec) DeepCopyInto(out *NetworkSpec) {
	*out = *in
	if in.NetworkIngressPorts != nil {
		in, out := &in.NetworkIngressPorts, &out.NetworkIngressPorts
		*out = make([]Ports, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.NetworkEgressPorts != nil {
		in, out := &in.NetworkEgressPorts, &out.NetworkEgressPorts
		*out = make([]Ports, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
